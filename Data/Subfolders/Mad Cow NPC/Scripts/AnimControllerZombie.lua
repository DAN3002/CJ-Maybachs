...
local ATTACK_ANIMATION = script:GetCustomProperty("AttackAnim") or "unarmed_bite"
...
local READY_STANCE = script:GetCustomProperty("ReadyStance") or "unarmed_idle_ready"
